// The original code comes from http://math.hws.edu/eck/cs424/notes2013/19_GLSL.html
//
//  It has been modified to include callback functions associated to touch screen events.
//  (the original code only handled mouse events). The modifications can be located by searching
//   for the marker //---
//
//
/**
...
*/
    ...
    //canvas.addEventListener("leftarrow", doLeftArrow, false);
    //canvas.addEventListener("rightarrow", doRightArrow, false);
    //canvas.addEventListener("downarrow", doDownArrow, false);
    //canvas.addEventListener("uparrow", doUpArrow, false);
}
